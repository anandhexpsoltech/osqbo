...
class EPIE_HTML_Elements {
				...
				<ul>					<?php
					...
					foreach( $args['options'] as $key => $label ) {
						...
						if( $args['current'] == $label ) {
						    $checked_list = 'epie-radio-checked';
						}						?>
	...
	public function confirmation_box_with_checkboxes( $args ) { ?>
        ...
        <div class="epie-notification-box">

            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">

                <section class="epie-header">
                    <h3><?php echo $args['header']; ?></h3>
                </section>

                <section class="epie-body">					<?php

                    if ( isset( $args['content'] ) ) {      ?>
                        <div class="epie-body-content"><?php echo $args['content']; ?></div>                    <?php
                    }

					if ( isset( $args['checkboxes'] ) ) {   ?>
                        <div class="epie-body-checkboxes">
                            <ul>
                ...
                <section class="epie-footer">   <?php
					if ( isset ( $args['cancel_button'] ) ) {   ?>
                        <button id="epie-notification-box-cancel" class="epie-error-btn"><?php echo $args['cancel_button']; ?></button>       <?php
					}   ?>
                    <button id="epie-notification-box-apply" class="epie-success-btn"><?php echo $args['apply_button']; ?></button>
                </section>  <?php
	...
	/*
		...
		$values:
		@param: string $value['id']            ( Required ) Container ID, used for targeting with other JS
		@param: string $value['type']          ( Required ) How it will look ( epie-error = Red  )
		@param: string $value['header']        ( Required ) The big Bold Main text
		@param: HTML   $value['content']       ( Required ) Any HTML P, List etc...
		@param: array  $value['checkboxes']    ( Optional ) Pass in an array of text labels.
	 */
	public function confirmation_box_with_checkboxes_collapse( $args ) { ?>
        ...
        <div class="epie-notification-box epie-collapse">
            ...
            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">
                ...
                <section class="epie-body">
                    <?php if ( isset( $args['content'] ) ) { ?>
                        <div class="epie-body-content"><?php echo $args['content']; ?></div>
                        <?php }	?>
	                <div class="epie-content-toggle"><?php echo $args['toggle_text']; ?><span class="epkbfa epkbfa-arrow-circle-down"></span> </div>
	...
	public function toggle_box( $args ) { ?>
        ...
        <div id="<?php echo $args['id']; ?>" class="epie-toggle-box epie-toggle-closed">

                <section class="epie-toggle-box-header">
                    <h3>
                        <?php echo $args['title']; ?>
                        <span class="epie-toggle-box-icon epkbfa epkbfa-arrow-circle-down"></span>
                    </h3>

                </section>

                <section class="epie-toggle-box-body">
                    <div class="epie-toggle-box-content"><?php echo $args['content']; ?></div>
                </section>
	...
	public function info_box( $args ) {  ?>
        ...
        <span id="<?php echo $args['id']; ?>" class="epie-info-box epie-info-toggle-closed">

            <div class="epie-info-box-icon epkbfa epkbfa-info-circle"></div>


            <div class="epie-info-box-popup">
                <div class="epie-info-box-container">
                    <span class="epie-info-box-close epkbfa epkbfa-times"></span>
                    <span class="epie-info-box-icon-max epkbfa epkbfa-expand"></span>
                    <span class="epie-info-box-icon-min epkbfa epkbfa-compress"></span>
                    <section class="epie-info-box-header">
                        <h3><?php echo $args['title']; ?></h3>
                    </section>
                    <section class="epie-info-box-body">
                        <div class="epie-info-box-content"><?php echo $args['content']; ?></div>
                    </section>
                </div>
            </div>
