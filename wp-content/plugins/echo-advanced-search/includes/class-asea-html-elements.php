...
class ASEA_HTML_Elements {
	...
	public function confirmation_box_with_checkboxes( $args ) { ?>
        ...
        <div class="asea-notification-box">

            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">

                <section class="asea-header">
                    <h3><?php echo $args['header']; ?></h3>
                </section>

                <section class="asea-body">					<?php

                    if ( isset( $args['content'] ) ) {      ?>
                        <div class="asea-body-content"><?php echo $args['content']; ?></div>                    <?php
                    }

					if ( isset( $args['checkboxes'] ) ) {   ?>
                        <div class="asea-body-checkboxes">
                            <ul>
                ...
                <section class="asea-footer">   <?php
					if ( isset ( $args['cancel_button'] ) ) {   ?>
                        <button id="asea-notification-box-cancel" class="asea-error-btn"><?php echo $args['cancel_button']; ?></button>       <?php
					}   ?>
                    <button id="asea-notification-box-apply" class="asea-success-btn"><?php echo $args['apply_button']; ?></button>
                </section>  <?php
	...
	/*
		...
		$values:
		@param: string $value['id']            ( Required ) Container ID, used for targeting with other JS
		@param: string $value['type']          ( Required ) How it will look ( asea-error = Red  )
		@param: string $value['header']        ( Required ) The big Bold Main text
		@param: HTML   $value['content']       ( Required ) Any HTML P, List etc...
		@param: array  $value['checkboxes']    ( Optional ) Pass in an array of text labels.
	 */
	public function confirmation_box_with_checkboxes_collapse( $args ) { ?>
        ...
        <div class="asea-notification-box asea-collapse">
            ...
            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">
                ...
                <section class="asea-body">
                    <?php if ( isset( $args['content'] ) ) { ?>
                        <div class="asea-body-content"><?php echo $args['content']; ?></div>
                        <?php }	?>
	                <div class="asea-content-toggle"><?php echo $args['toggle_text']; ?><span class="epkbfa epkbfa-arrow-circle-down"></span> </div>
	...
	public function toggle_box( $args ) { ?>
        ...
        <div id="<?php echo $args['id']; ?>" class="asea-toggle-box asea-toggle-closed">

                <section class="asea-toggle-box-header">
                    <h3>
                        <?php echo $args['title']; ?>
                        <span class="asea-toggle-box-icon epkbfa epkbfa-arrow-circle-down"></span>
                    </h3>

                </section>

                <section class="asea-toggle-box-body">
                    <div class="asea-toggle-box-content"><?php echo $args['content']; ?></div>
                </section>
	...
	public function info_box( $args ) {  ?>
        ...
        <span id="<?php echo $args['id']; ?>" class="asea-info-box asea-info-toggle-closed">

            <div class="asea-info-box-icon epkbfa epkbfa-info-circle"></div>


            <div class="asea-info-box-popup">
                <div class="asea-info-box-container">
                    <span class="asea-info-box-close epkbfa epkbfa-times"></span>
                    <span class="asea-info-box-icon-max epkbfa epkbfa-expand"></span>
                    <span class="asea-info-box-icon-min epkbfa epkbfa-compress"></span>
                    <section class="asea-info-box-header">
                        <h3><?php echo $args['title']; ?></h3>
                    </section>
                    <section class="asea-info-box-body">
                        <div class="asea-info-box-content"><?php echo $args['content']; ?></div>
                    </section>
                </div>
            </div>
