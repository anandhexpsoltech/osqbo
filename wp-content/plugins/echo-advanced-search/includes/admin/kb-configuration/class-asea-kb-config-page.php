...
class ASEA_KB_Config_Page {
	...
	public function __construct() {
		add_filter( 'eckb_search_box_configuration',  array( $this, 'replace_search_nav_menu_list' ) );
	...
	/**
	 * Replace KB core search nav lists with Advanced Search links
	 * @return array
	 */
	public function replace_search_nav_menu_list( $search_box  /** unused */ ) {
		$menu_list = array(
			'heading'   => 'Advanced Search Box',
			'links'     => array(  'Setup', 'Colors', 'Text', 'Advanced' )
		);
		return $menu_list;
	}
	...
	public function kb_config_option_group( $args, $kb_config, $kb_page_layout ) {
		...
		$is_main_page_config = $kb_page_layout == 'Basic' || $kb_page_layout == 'Tabs' || $kb_page_layout == 'Grid' || ( $kb_page_layout == 'Sidebar' && $kb_config['kb_main_page_layout'] == 'Sidebar' );
		...
		if ( strpos($menu_classes, 'eckb-mm-mp-links-tuning-searchbox-advanced') !== false || strpos($menu_classes, 'eckb-mm-ap-links-tuning-searchbox-advanced') !== false ) {
			...
			return $this->set_search_box_color_options( $kb_config, $page_ix );
		}
	...
	private function set_search_box_setup_options( $kb_config, $ix ) {
		...
		$form->option_group_filter( $kb_config, $feature_specs, array(
			...
			'inputs' => array(
				...
				'0' => $form->text( $feature_specs['advanced_search_' . $ix . '_title_font_size'] + array(
						'value'             => $kb_config['advanced_search_' . $ix . '_title_font_size'],
						'input_group_class' => 'config-col-12',
						'label_class'       => 'config-col-5',
						'input_class'       => 'config-col-4'
					) ),
				'1' => $form->dropdown( $feature_specs['advanced_search_' . $ix . '_title_font_weight'] + array(
						'value' => $kb_config['advanced_search_' . $ix . '_title_font_weight'],
						'current' => $kb_config['advanced_search_' . $ix . '_title_font_weight'],
						'input_group_class' => 'config-col-12',
						'label_class'       => 'config-col-5',
						'input_class'       => 'config-col-4'
					)),
		...
		$form->option_group_filter( $kb_config, $feature_specs, array(
			...
			'inputs' => array(
				...
				'0' => $form->text( $feature_specs['advanced_search_' . $ix . '_description_below_title_font_size'] + array(
						'value'             => $kb_config['advanced_search_' . $ix . '_description_below_title_font_size'],
						'input_group_class' => 'config-col-12',
						'label_class'       => 'config-col-5',
						'input_class'       => 'config-col-4'
					) ),
		...
		$form->option_group_filter( $kb_config, $feature_specs, array(
			...
			'inputs' => array(
				...
				'0' => $form->text( $feature_specs['advanced_search_' . $ix . '_description_below_input_font_size'] + array(
						'value'             => $kb_config['advanced_search_' . $ix . '_description_below_input_font_size'],
						'input_group_class' => 'config-col-12',
						'label_class'       => 'config-col-5',
						'input_class'       => 'config-col-4'
					) ),
	...
	private function set_search_box_advanced_options( $kb_config, $ix ) {
		...
		$search_input_input_arg4 = $feature_specs['advanced_search_' . $ix . '_input_box_font_size'] + array(
				'value'             => $kb_config['advanced_search_' . $ix . '_input_box_font_size'],
				'input_group_class' => 'config-col-12',
				'label_class'       => 'config-col-6',
				'input_class'       => 'config-col-2'
