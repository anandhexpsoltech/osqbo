...
class ASEA_KB_Config_Specs {
	...
	public static function get_fields_specification() {
		...
		$default_style = array(
				...
				//Title Settings
				'advanced_search_title_font_size'                       =>  36,
				'advanced_search_title_font_weight'                     =>  'normal',
				...
				'advanced_search_title_tag'                             =>	'h1',

				//Description 1 Settings
				'advanced_search_description_below_title_font_size'     =>  16,
				...
				'advanced_search_input_box_font_size'                   =>  18,
				...
				'advanced_search_description_below_input_font_size'             =>  16,
		...
		self::$cached_specs = array_merge( $main_page_config_specification, $article_page_config_specification );
	...
	private static function get_main_page_fields_specification( $default_color, $default_style ) {
		$config_specification = array(
			...
			'advanced_search_mp_title_font_color'               => array(
				'label'       => __( 'Text', 'echo-advanced-search' ),
			...
			'advanced_search_mp_title'                          => array(
				...
				'min'         => '1',
				'mandatory'   => false,
				'type'        => ASEA_Input_Filter::WP_EDITOR,
			...
			'advanced_search_mp_filter_indicator_text'          => array(
				'label'       => __( 'Text for Filter indicator', 'echo-advanced-search' ),
			...
			'advanced_search_mp_title_font_size'                => array(
				'label'       => __( 'Title Font Size ( px )', 'echo-advanced-search' ),
				'name'        => 'advanced_search_mp_title_font_size',
				'max'         => '100',
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_title_font_size']
			),
			'advanced_search_mp_title_font_weight'              => array(
				'label'       => __( 'Title Font Weight', 'echo-advanced-search' ),
				'name'        => 'advanced_search_mp_title_font_weight',
				'type'        => ASEA_Input_Filter::SELECTION,
				'options'     => array(
					'normal' => __( 'Normal' ),
					'bold'   => __( 'Bold' )
				),
				'default'     => $default_style['advanced_search_title_font_weight']
			),
			'advanced_search_mp_title_padding_bottom'           => array(
				...
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_title_padding_bottom']
			),
			...
			'advanced_search_mp_description_below_title_font_size'        => array(
				'label'       => __( 'Font Size ( px )', 'echo-advanced-search' ),
				'name'        => 'advanced_search_mp_description_below_title_font_size',
				'max'         => '100',
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_description_below_title_font_size']
			),
			'advanced_search_mp_description_below_title_padding_top'      => array(
				...
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_description_below_title_padding_top']
			),
			'advanced_search_mp_description_below_title_padding_bottom'   => array(
				...
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_description_below_title_padding_bottom']
			),
			...
			'advanced_search_mp_input_box_font_size'            => array(
				'label'       => __( 'Font Size', 'echo-advanced-search' ),
				'name'        => 'advanced_search_mp_input_box_font_size',
				'max'         => '50',
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_input_box_font_size']
			),
			...
			'advanced_search_mp_description_below_input_font_size'        => array(
				'label'       => __( 'Font Size ( px )', 'echo-advanced-search' ),
				'name'        => 'advanced_search_mp_description_below_input_font_size',
				'max'         => '100',
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_description_below_input_font_size']
			),
			'advanced_search_mp_description_below_input_padding_top'      => array(
				...
				'min'         => 0,
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_description_below_input_padding_top']
			),
			'advanced_search_mp_description_below_input_padding_bottom'   => array(
				...
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_description_below_input_padding_bottom']
			),
			...
			'advanced_search_mp_background_pattern_image_position_x'    => array(
				'label'       => __( 'Background Pattern Image Position X', 'echo-advanced-search' ),
			...
			'advanced_search_mp_background_pattern_image_position_y'    => array(
				'label'       => __( 'Background Pattern Image Position Y', 'echo-advanced-search' ),
	...
	private static function get_article_page_fields_specification( $default_color, $default_style ) {
		$config_specification = array(
			...
			'advanced_search_ap_search_result_category_color'    => array(
				'label'       => __( 'Category Color in search result', 'echo-advanced-search' ),
			...
			'advanced_search_ap_show_top_category'              => array(
					'label'       => __( 'Show Top Category', 'echo-advanced-search' ),
			...
			//Title Settings
			'advanced_search_ap_title_font_size'                => array(
				'label'       => __( 'Title Font Size ( px )', 'echo-advanced-search' ),
				'name'        => 'advanced_search_ap_title_font_size',
				'max'         => '100',
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_title_font_size']
			),
			'advanced_search_ap_title_font_weight'              => array(
				'label'       => __( 'Title Font Weight', 'echo-advanced-search' ),
				'name'        => 'advanced_search_ap_title_font_weight',
				'type'        => ASEA_Input_Filter::SELECTION,
				'options'     => array(
					'normal' => __( 'Normal' ),
					'bold'   => __( 'Bold' )
			...
			//Description 1 Settings
			'advanced_search_ap_description_below_title_font_size'        => array(
				'label'       => __( 'Font Size ( px )', 'echo-advanced-search' ),
				'name'        => 'advanced_search_ap_description_below_title_font_size',
				'max'         => '100',
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_description_below_title_font_size']
			...
			'advanced_search_ap_input_box_font_size'            => array(
				'label'       => __( 'Font Size', 'echo-advanced-search' ),
				'name'        => 'advanced_search_ap_input_box_font_size',
				'max'         => '50',
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_input_box_font_size']
			...
			'advanced_search_ap_description_below_input_font_size'        => array(
				'label'       => __( 'Font Size ( px )', 'echo-advanced-search' ),
				'name'        => 'advanced_search_ap_description_below_input_font_size',
				'max'         => '100',
				'min'         => '0',
				'type'        => ASEA_Input_Filter::NUMBER,
				'default'     => $default_style['advanced_search_description_below_input_font_size']
