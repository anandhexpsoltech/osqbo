...
class ASEA_Search_Logging {
	 ...
	 * @param $kb_id
	 */
	public static function add_search_log( $user_input, $search_keywords, $count, $source='kb-main-page', $kb_id='' ) {
		...
		if ( empty($search_keywords) ) {
			...
			$search_keywords = $search_db->get_search_keywords($user_input);
		}
		...
		$db_handler->insert_search_record( $kb_id, $user_id, $user_uid, $user_input, $search_keywords, $count );
	}
}