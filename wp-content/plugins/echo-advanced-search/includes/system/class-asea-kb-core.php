...
class ASEA_KB_Core {
	...
	const ASEA_THEME_WIZARD_GET_THEME_CONFIG = 'epkb_theme_wizard_get_themes';
	const ASEA_SEARCH_WIZARD_MAIN_PAGE_CLASSES = 'search_wizard_main_page_classes';
	...
	const ASEA_SEARCH_WIZARD_AFTER_MAIN_PAGE = 'epkb_search_wizard_after_main_page';
	const ASEA_SEARCH_WIZARD_AFTER_ARTICLE_PAGE = 'epkb_search_wizard_after_article_page';
	...
	const ASEA_SEARCH_WIZARD_MAIN_PAGE_BEFORE_PREVIEW = 'search_wizard_main_page_before_preview_action';
	...
	const ASEA_KB_SEARCH_FIELDS_LIST                = 'epkb_kb_search_fields_list';
