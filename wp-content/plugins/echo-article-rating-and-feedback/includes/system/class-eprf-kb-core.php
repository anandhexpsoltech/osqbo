...
class EPRF_KB_Core {
	...
	const EPRF_ADVANCED_CONFIG_AFTER_ARTICLE_PAGE = 'epkb_advanced_config_after_article_page';
	...
	const EPRF_SAVE_KB_ADVANCED_CONFIG_CHANGES = 'epkb_save_kb_advanced_config_changes';
