...
class EPRF_KB_Config_Page {
	...
	public function __construct() {
		...
		EPRF_KB_Config_Advanced::register__hooks();
	}
        ...
        echo    '<div class="ep'.'kb-config-sidebar-options">';
	            ...
	            $form->option_group( $feature_specs, array(
			            ...
			            'inputs'            => array(
								...
								'1' => $form->dropdown( $feature_specs['rating_stats_meta'] + array(
										'value'             => $add_on_config['rating_stats_meta'],
										'current'           => $add_on_config['rating_stats_meta'],
										'input_group_class' => 'config-col-12',
										'label_class'       => 'config-col-4',
								...
								'4' => $form->text( $feature_specs['rating_like_style_no_button'] + array(
										...
										'label_class'       => 'config-col-4',
										'input_class'       => 'config-col-5') ),
								'5' => $form->text( $feature_specs['rating_stars_text_1'] + array(
										'value'             => $add_on_config['rating_stars_text_1'],
										'input_group_class' => 'config-col-12 stars-mode',
										'label_class'       => 'config-col-4',
										'input_class'       => 'config-col-7'
									) ),
								'6' => $form->text( $feature_specs['rating_stars_text_2'] + array(
										'value'             => $add_on_config['rating_stars_text_2'],
										'input_group_class' => 'config-col-12 stars-mode',
										'label_class'       => 'config-col-4',
										'input_class'       => 'config-col-7'
									) ),
								'7' => $form->text( $feature_specs['rating_stars_text_3'] + array(
										'value'             => $add_on_config['rating_stars_text_3'],
										'input_group_class' => 'config-col-12 stars-mode',
										'label_class'       => 'config-col-4',
										'input_class'       => 'config-col-7'
									) ),
								'8' => $form->text( $feature_specs['rating_stars_text_4'] + array(
										'value'             => $add_on_config['rating_stars_text_4'],
										'input_group_class' => 'config-col-12 stars-mode',
										'label_class'       => 'config-col-4',
										'input_class'       => 'config-col-7'
									) ),
								'9' => $form->text( $feature_specs['rating_stars_text_5'] + array(
	            ...
	            $form->option_group( $feature_specs, array(
			            ...
			            'class'             => 'eckb-mm-ap-links-ratingandfeedback-features-articlerating',
			            'inputs'            => array(
				                '0' => $form->dropdown( $feature_specs['rating_element_location'] + array(
						                        'value'             => $add_on_config['rating_element_location'],
						                        'current'           => $add_on_config['rating_element_location'],
						                        'input_group_class' => 'config-col-12',
						                        'label_class'       => 'config-col-4',
						                        'input_class'       => 'config-col-7'
					            ) ),
								...
								'5' => $form->text( $feature_specs['rating_text_font_size'] + array(
												'value'             => $add_on_config['rating_text_font_size'],
												'input_group_class' => 'config-col-12',
												'label_class'       => 'config-col-4',
												'input_class'       => 'config-col-2'
										) ),
