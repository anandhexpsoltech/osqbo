		...
		$form->option_group_wizard( $eprf_specs, array(
			...
			'inputs'            => array(
				...
				'1' => $form->text( $eprf_specs['rating_confirmation_positive'] + array(
						...
						'data' => array(
							'wizard_input' => '1',
							'example_image'     => '[eprf]text-wizard/wizard-screenshot-rating-positive.jpg'
						)
					) ),
				'2' => $form->text( $eprf_specs['rating_confirmation_negative'] + array(
						...
						'data' => array(
							'wizard_input' => '1',
							'example_image'     => '[eprf]theme-wizard/wizard-screenshot-no-image-available.jpg'
						)
					) )
			)
		));
			...
			'inputs'            => array(
				'0' => $form->text( $eprf_specs['rating_feedback_title'] + array(
						...
						'data' => array(
							...
							'text' => '1',
							'example_image'     => '[eprf]text-wizard/wizard-screenshot-rating-feedback-title.jpg'
						)
					) ),
				'1' => $form->text( $eprf_specs['rating_feedback_description'] + array(
						...
						'data' => array(
							...
							'example_image'     => '[eprf]text-wizard/wizard-screenshot-rating-feedback-description.jpg'
						)
					) ),
				'2' => $form->text( $eprf_specs['rating_feedback_support_link_text'] + array(
						...
						'data' => array(
							...
							'text' => '1',
							'example_image'     => '[eprf]text-wizard/wizard-screenshot-rating-link-text.jpg'
						)
					) ),
				'3' => $form->text( $eprf_specs['rating_feedback_support_link_url'] + array(
						...
						'data' => array(
							...
							'target_selector' => '.eprf-article-feedback__support-link a',
							'target_attr' => 'href',
							'example_image'     => '[eprf]text-wizard/wizard-screenshot-rating-support-url.jpg'
						)
					) ),
				'4' => $form->text( $eprf_specs['rating_feedback_button_text'] + array(
						...
						'data' => array(
							...
							'example_image'     => '[eprf]text-wizard/wizard-screenshot-rating-button-text.jpg'
						)
					) ),
			)
		));
