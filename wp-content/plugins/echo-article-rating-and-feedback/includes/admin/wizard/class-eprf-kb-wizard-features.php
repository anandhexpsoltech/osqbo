...
class EPRF_KB_Wizard_Features {
	...
	public static function add_article_page_features ( $kb_id, $kb_config ) {
		...
		$form->option_group_wizard( $eprf_specs, array(
			...
			'inputs'            => array(
				'0' => $form->dropdown( $eprf_specs['rating_mode'] + array(
				...
				'1' => $form->radio_buttons_vertical( $eprf_specs['rating_layout'] + array(
				...
				'2' => $form->dropdown( $eprf_specs['rating_stats_meta'] + array(
						'value' => $eprf_config['rating_stats_meta'],
						'current' => $eprf_config['rating_stats_meta'],
						'input_group_class' => 'eckb-wizard-single-dropdown',
						'label_class' => 'config-col-5',
						'input_class' => 'config-col-4',
						'data' => array(
				...
				'3' => $form->dropdown( $eprf_specs['rating_element_location'] + array(
						'value' => $eprf_config['rating_element_location'],
						'current' => $eprf_config['rating_element_location'],
						'input_group_class' => 'eckb-wizard-single-dropdown',
						'label_class' => 'config-col-5',
						'input_class' => 'config-col-4',
						'data' => array(
				...
				'4' => $form->checkbox( $eprf_specs['rating_feedback_name_prompt'] + array(
						...
						'data' => array(
							'preview' => 1,
							'example_image'     => '[eprf]features-wizard/wizard-screenshot-feedback-show-name.jpg'
						)
					) ),
				'5' => $form->checkbox( $eprf_specs['rating_feedback_email_prompt'] + array(
						...
						'data' => array(
							'preview' => 1,
							'example_image'     => '[eprf]features-wizard/wizard-screenshot-feedback-show-email.jpg'
						)
					) ),
			)
		));
