...
class EPRF_KB_Wizard {
	...
	public static function get_configuration_defaults( $template_defaults ) {
		...
		$eprf_template_defaults = array (
		);

		return array_merge($template_defaults, $kb_eprf_defaults, $eprf_template_defaults);
	}
			...
			'inputs'            => array(
				'0' => $form->text( $eprf_specs['rating_feedback_button_color'] + array(
						...
						'data' => array(
							...
							'example_image'     => '[eprf]theme-wizard/wizard-screenshot-rating-button-color.jpg'
						)
					) ),
				'2' => $form->text( $eprf_specs['rating_text_color'] + array(
						...
						'data' => array(
							...
							'style_name' => 'color',
							'example_image'     => '[eprf]theme-wizard/wizard-screenshot-rating-text-color.jpg'
						)
					) )
			)
		));
			...
			'inputs'            => array(
				...
				'1' => $form->text( $eprf_specs['rating_dropdown_color'] + array(
						...
						'data' => array(
							...
							'style_name' => 'color',
							'example_image'     => '[eprf]theme-wizard/wizard-screenshot-rating-dropdown-color.jpg'
						)
					) ),
			)
		));
