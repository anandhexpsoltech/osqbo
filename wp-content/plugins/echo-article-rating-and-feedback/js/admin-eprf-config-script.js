jQuery(document).ready(function($) {
	...
	$('#eckb-mm-ap-links-ratingandfeedback-features-articlerating, #eckb-mm-ap-links-ratingandfeedback-features-articlefeedback').click(eprf_check_mode);
	$('#rating_mode').change(eprf_check_mode);
