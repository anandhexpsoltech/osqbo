...
class ELAY_KB_Wizard_Features {
	...
	public static function add_main_page_features ( $kb_id ) {
		...
		$form->option_group_wizard( $elay_specs, array(
			...
			'inputs' => array(
				'0' => $form->dropdown( $elay_specs['grid_width'] + array(
						'value' => $elay_config['grid_width'],
						'current' => $elay_config['grid_width'],
						...
						'data' => array(
							'example_image' => '[elay]features-wizard/wizard-screenshot-page-width.jpg'
						)
					) ),
				...
				'2' => $form->dropdown( $elay_specs['grid_section_font_size'] + array(
						'value' => $elay_config['grid_section_font_size'],
						'current' => $elay_config['grid_section_font_size'],
						'input_group_class' => 'eckb-wizard-single-dropdown',
						'label_class' => 'config-col-5',
						'input_class' => 'config-col-4',
						'data' => array(
	...
	public static function add_article_page_features ( $kb_id, $kb_config ) {
		...
		$form->option_group_wizard( $elay_specs, array(
			...
			'inputs' => array(
				...
				'3' => $form->dropdown( $elay_specs['sidebar_section_font_size'] + array(
						'value' => $elay_config['sidebar_section_font_size'],
						'current' => $elay_config['sidebar_section_font_size'],
						'input_group_class' => 'eckb-wizard-single-dropdown',
						'label_class' => 'config-col-5',
						'input_class' => 'config-col-4',
						'data' => array(
