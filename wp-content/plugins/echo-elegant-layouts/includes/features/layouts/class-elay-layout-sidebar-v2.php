...
class ELAY_Layout_Sidebar_v2 extends ELAY_Layout {
	...
	public function generate_search_box_V2( $args ) {
		...
		$this->display_kb_page( $args['config'] );
	...
	public function generate_sidebar_V2( $args ) {
		...
		$this->display_kb_page( $args['config'], $is_builder_on, $article_seq, $categories_seq );
	...
	public function generate_sidebar_CSS_V2( $kb_config ) {
		...
		<style>
			...
			/* Container */
			#elay-sidebar-container-v2<?php echo $theme_class; ?> {
			...
			/* Category Heading */
			#elay-sidebar-container-v2<?php echo $theme_class; ?> .elay-sidebar__cat__top-cat__heading-container {
			...
			#elay-sidebar-container-v2<?php echo $theme_class; ?> .elay-sidebar__cat__top-cat:first-child .elay-sidebar__cat__top-cat__heading-container {
			...
			#elay-sidebar-container-v2<?php echo $theme_class; ?> .elay-sidebar__cat__top-cat:last-child .elay-sidebar__cat__top-cat__heading-container {
			...
			#elay-sidebar-container-v2<?php echo $theme_class; ?> .elay-sidebar__heading__inner .elay-sidebar__heading__inner__name, #elay-sidebar-container-v2<?php echo $theme_class; ?> .elay-sidebar__heading__inner .elay-sidebar__heading__inner__name>a {
				color:                  <?php echo $catHeadingInner_fontColor.';' .PHP_EOL; ?>
				text-align:             <?php echo $catHeadingInner_TextAlignment.';' .PHP_EOL; ?>
			}
			#elay-sidebar-container-v2<?php echo $theme_class; ?> .elay-sidebar__heading__inner .elay-sidebar__heading__inner__desc p {
				color:                  <?php echo $catHeadingInner_DescColor.';' .PHP_EOL; ?>
				text-align:             <?php echo $catHeadingInner_TextAlignment.';' .PHP_EOL; ?>
			}

			/* Category Body */
			#elay-sidebar-container-v2<?php echo $theme_class; ?> .elay-sidebar__cat__top-cat__body-container {
			...
			/* Category Main Category */
			#elay-sidebar-container-v2<?php echo $theme_class; ?> .elay-sidebar__cat__top-cat__body-container .elay-sidebar__body__main-cat {}

			/* Category Sub Category */
			#elay-sidebar-container-v2<?php echo $theme_class; ?> .elay-sidebar__cat__top-cat__body-container .elay-sidebar__body__sub-cat {
	...
	private function display_sidebar_V2() {
		...
		if ( ! empty($this->kb_config['sidebar_section_font_size'] ) ) {
			switch ($this->kb_config['sidebar_section_font_size']) {
				case 'section_xsmall_font':
					$fontSize = 'elay-sidebar--xsFont';
					break;
				case 'section_small_font':
					$fontSize = 'elay-sidebar--sFont';
					break;
				case 'section_medium_font':
					$fontSize = 'elay-sidebar--mFont';
					break;
				case 'section_large_font':
					$fontSize = 'elay-sidebar--LFont';
					break;
			}
		}
		...
		$theme_class_original = !empty($this->kb_config['theme_name']) ? '.eckb-theme-' . $this->kb_config['theme_name'] : '';

		$theme_class = str_replace(".","",$theme_class_original );

		$this->generate_sidebar_CSS_V2( $this->kb_config );		?>

		<section id="elay-sidebar-container-v2" class="elay-sidebar--reset <?php echo $fontSize.' '.$boxShadow.' '.$slimScrollbar.' '.$sidebar_top_categories_collapsed_Class . ' ' . $theme_class;?>">
	...
	private function display_section_body_V2( $subcategories, $category_id ) { ?>
		...
		<div class="elay-sidebar__cat__top-cat__body-container">  <?php
