...
class ELAY_Layout_Sidebar extends ELAY_Layout {
	...
	public function get_article() {
		...
		$article = ELAY_Utilities::get_kb_post_secure( $article_id );
	...
	*/
	...
	private function display_main_page_content_inner() {
		...
		$side_bar_class = $this->get_css_class('elay-sidebar, ::sidebar_section_font_size ,::sidebar_section_box_shadow, ::sidebar_scroll_bar ' );		    ?>
