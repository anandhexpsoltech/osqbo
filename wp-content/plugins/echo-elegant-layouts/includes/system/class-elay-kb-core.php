...
class ELAY_KB_Core {
	...
	const ELAY_KB_REGISTER_KB_CONFIG_HOOKS = 'epkb_register_kb_config_hooks';
	const ELAY_KB_MAX_LAYOUT_LEVEL = 'epkb_max_layout_level';
	const ELAY_KB_LAYOUT_INFO_MESSAGE = 'epkb_layout_info_message';
	const ELAY_KB_STYLE_NAMES = 'epkb_style_names';
	...
	const ELAY_THEME_WIZARD_GET_THEMES = 'epkb_theme_wizard_get_themes';
	...
	const ELAY_SEARCH_WIZARD_ARTICLE_PAGE_FEATURES = 'epkb_search_wizard_after_article_page';
	const ELAY_SEARCH_WIZARD_MAIN_PAGE_FEATURES = 'epkb_search_wizard_after_main_page';
	const ELAY_ADVANCED_CONFIG_AFTER_MAIN_PAGE = 'epkb_advanced_config_after_main_page';
	const ELAY_ADVANCED_CONFIG_AFTER_ARTICLE_PAGE = 'epkb_advanced_config_after_article_page';
	// AJAX action events
	...
	const ELAY_SAVE_KB_ADVANCED_CONFIG_CHANGES = 'epkb_save_kb_advanced_config_changes';
	...
	// Configuration handlers - MAIN PAGE
	const ELAY_KB_MAIN_PAGE_STYLE_SETTINGS = 'epkb_kb_main_page_style_settings';
	const ELAY_KB_MAIN_PAGE_COLORS_SETTINGS = 'epkb_kb_main_page_colors_settings';
	const ELAY_KB_MAIN_PAGE_TEXT_SETTINGS = 'epkb_kb_main_page_text_settings';
	const ELAY_KB_MAIN_PAGE_COLORS_SET = 'epkb_kb_main_page_colors_set';
	const ELAY_KB_MAIN_PAGE_STYLE_SET = 'epkb_kb_main_page_style_set';
	// Configuration handlers - ARTICLE PAGE
	const ELAY_ARTICLE_PAGE_STYLE_SETTINGS = 'epkb_article_page_style_settings';
	const ELAY_ARTICLE_PAGE_COLORS_SETTINGS = 'epkb_article_page_colors_settings';
	const ELAY_ARTICLE_PAGE_TEXT_SETTINGS = 'epkb_article_page_text_settings';
	const ELAY_ARTICLE_PAGE_COLORS_SET = 'epkb_article_page_colors_set';
	const ELAY_ARTICLE_PAGE_STYLE_SET = 'epkb_article_page_style_set';
