...
class AMGP_Access_Page_Cntrl_Users extends AMGP_Access_Page_Controller {
	...
	public function add_kb_group_user() {
		...
		// we are done here
		AMGP_Utilities::ajax_show_info_die( __( 'Added User to Group', 'echo-knowledge-base' ) );
	}
	...
	public function remove_kb_group_user() {
		...
		// we are done here
		AMGP_Utilities::ajax_show_info_die( __( 'Removed User from Group', 'echo-knowledge-base' ) );
	}
	...
	private function update_kb_managers( $wp_user_id, $action ) {
		...
		// we are done here
		AMGP_Utilities::ajax_show_info_die( __( 'Removed User', 'echo-knowledge-base' ) );
	}
}