 ...
 */
function amgp_load_public_resources() {
	...
	amgp_load_public_resources_now();
}
add_action( 'wp_enqueue_scripts', 'amgp_load_public_resources' );

function amgp_load_public_resources_now() {

	$suffix = ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) ? '' : '.min';

	wp_enqueue_style( 'amgp-public-styles', Echo_KB_Groups::$plugin_url . 'css/public-styles' . $suffix . '.css', array(), Echo_KB_Groups::$version );
	wp_enqueue_script( 'amgp-public-scripts', Echo_KB_Groups::$plugin_url . 'js/public-scripts' . $suffix . '.js', array(), Echo_KB_Groups::$version );
	wp_localize_script( 'amgp-public-scripts', 'amgp_vars', array(
