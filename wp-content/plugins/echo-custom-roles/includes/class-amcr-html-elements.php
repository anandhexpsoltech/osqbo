...
class AMCR_HTML_Elements {
	...
	public function confirmation_box_with_checkboxes( $args ) { ?>
        ...
        <div class="amag-notification-box">
            ...
            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">
                ...
                <section class="amag-body">					<?php

                    if ( isset( $args['content'] ) ) {      ?>
                        <div class="amag-body-content"><?php echo $args['content']; ?></div>                    <?php
                    }

					if ( isset( $args['checkboxes'] ) ) {   ?>
                        <div class="amag-body-checkboxes">
                            <ul>
                ...
                <section class="amcr-footer">   <?php
					if ( isset ( $args['cancel_button'] ) ) {   ?>
                        <button id="amag-notification-box-cancel" class="amag-error-btn"><?php echo $args['cancel_button']; ?></button>       <?php
					}   ?>
                    <button id="amag-notification-box-apply" class="amag-success-btn"><?php echo $args['apply_button']; ?></button>
                </section>  <?php
	...
	/*
		...
		$values:
		@param: string $value['id']            ( Required ) Container ID, used for targeting with other JS
		@param: string $value['type']          ( Required ) How it will look ( amcr-error = Red  )
		@param: string $value['header']        ( Required ) The big Bold Main text
		@param: HTML   $value['content']       ( Required ) Any HTML P, List etc...
		@param: array  $value['checkboxes']    ( Optional ) Pass in an array of text labels.
	 */
	public function confirmation_box_with_checkboxes_collapse( $args ) { ?>
        ...
        <div class="amag-notification-box amag-collapse">
            ...
            <form id="<?php echo $args['form_id']; ?>" class="<?php echo $args['type']; ?>">
                ...
                <section class="amag-body">
                    <?php if ( isset( $args['content'] ) ) { ?>
                        <div class="amag-body-content"><?php echo $args['content']; ?></div>
                        <?php }	?>
	                <div class="amag-content-toggle"><?php echo $args['toggle_text']; ?><span class="fa fa-arrow-circle-down"></span> </div>
	...
	public function toggle_box( $args ) { ?>
        ...
        <div id="<?php echo $args['id']; ?>" class="amag-toggle-box amag-toggle-closed">

                <section class="amag-toggle-box-header">
                    <h3>
                        <?php echo $args['title']; ?>
                        <span class="amag-toggle-box-icon fa fa-arrow-circle-down"></span>
                    </h3>

                </section>

                <section class="amag-toggle-box-body">
                    <div class="amag-toggle-box-content"><?php echo $args['content']; ?></div>
                </section>
	...
	public function info_box( $args ) {  ?>
        ...
        <span id="<?php echo $args['id']; ?>" class="amag-info-box amag-info-toggle-closed">

            <div class="amag-info-box-icon fa fa-info-circle"></div>


            <div class="amag-info-box-popup">
                <div class="amag-info-box-container">
                    <span class="amag-info-box-close fa fa-times"></span>
                    <span class="amag-info-box-icon-max fa fa-expand"></span>
                    <span class="amag-info-box-icon-min fa fa-compress"></span>
                    <section class="amag-info-box-header">
                        <h3><?php echo $args['title']; ?></h3>
                    </section>
                    <section class="amag-info-box-body">
                        <div class="amag-info-box-content"><?php echo $args['content']; ?></div>
                    </section>
                </div>
            </div>
