 ...
 */
function amcr_load_public_resources() {
	...
	amcr_load_public_resources_now();
}
add_action( 'wp_enqueue_scripts', 'amcr_load_public_resources' );

function amcr_load_public_resources_now() {

	$suffix = ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) ? '' : '.min';

	wp_enqueue_style( 'amcr-public-styles', Echo_Custom_roles::$plugin_url . 'css/public-styles' . $suffix . '.css', array(), Echo_Custom_roles::$version );
	wp_enqueue_script( 'amcr-public-scripts', Echo_Custom_roles::$plugin_url . 'js/public-scripts' . $suffix . '.js', array(), Echo_Custom_roles::$version );
	wp_localize_script( 'amcr-public-scripts', 'amcr_vars', array(
