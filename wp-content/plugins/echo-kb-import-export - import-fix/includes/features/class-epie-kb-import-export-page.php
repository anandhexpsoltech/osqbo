...
class EPIE_KB_Import_Export_Page {
	...
	public function __construct() {
		...
		add_action( 'eckb_manage_content_export_tab_body', array( $this, 'display_export_articles_section' ), 11, 2);
	}
	...
	/**
	 * Display all content for the export
	 * @param $kb_id
	 */
	public function display_export_articles_section( $kb_id ) {  ?>
		<div class="epie-admin-info-box">

			<div class="epie-content epie-content--active" id="epie-content-export">

				<div class="epie-admin-info-box__header">
					<div class="epie-admin-info-box__header__icon epkbfa epkbfa-download"></div>
					<div class="epie-admin-info-box__header__title"><?php _e('Export KB Content', 'echo-kb-import-export'); ?></div>

				</div>
				<div class="epie-admin-info-box__body">

					<div class="epie-export-form"><?php

						if (EPIE_Utilities_Export::can_export()) { ?>
							<form id="export-main-form">
								<div class="epie-form-field-intruction-wrap">
									<p>This export will output in CSV the following KB content:</p>
									<ul>
										<li>KB Articles.</li>
										<li>KB Categories.</li>
										<li>KB Tags.</li>
								...
								<div class="epie-progress" data-start="<?php _e('Starting Export', 'echo-knowledge-base'); ?>">
									<div class="epie-progress__bar">
										<div style="width:0%;"></div>
									</div>
									<div class="epie-progress__log">
								...
								<label class="epie-form-label" id="export-form-button-wrap">
									<input type="hidden" id="_wpnonce_kb_import_export" name="_wpnonce_kb_import_export" value="<?php echo wp_create_nonce( '_wpnonce_kb_import_export' ) ?>"/>
									<input class="epie-form-label__input epie-form-label__input--submit epie-aibb-btn epie-aibb-btn--blue" type="submit" value="<?php _e('Export KB Articles', 'echo-knowledge-base'); ?>">
									<a class="epie-aibb-btn epie-aibb-btn--blue" href="#" target="_blank" style="display: none;" id="export_file_link"  download><?php _e('Get export file', 'echo-knowledge-base'); ?></a>
								</label>
							</form> <?php
						} else {
							echo '<p>' . __('Only users with administrative privilege can export data', 'echo-knowledge-base') . '</p>';
						}						?>
