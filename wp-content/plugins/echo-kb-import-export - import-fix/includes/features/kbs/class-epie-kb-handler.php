 ...
 */
class EPIE_KB_Handler {

	// Prefix for custom post type name associated with given KB; this will never change
	const KB_POST_TYPE_PREFIX = EPIE_KB_Core::EPIE_KB_POST_TYPE_PREFIX;  // changing this requires db update
	...
	public static function get_post_type( $kb_id ) {
		$kb_id = EPIE_Utilities::sanitize_int($kb_id, EPIE_KB_Core::DEFAULT_KB_ID );
	...
	public static function get_kb_id_from_post_type( $post_type ) {
		...
		if ( ! EPIE_Utilities::is_positive_int( $kb_id ) ) {
