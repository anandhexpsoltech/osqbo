...
jQuery(document).ready(function($) {
	...
	window.EPKBEditor = {
		...
		afterLoadIframe: function( event ) {
			...
			app.iframe.find( 'a' ).each( function(e){
			...
			// for new links 
			app.iframe.on('click', 'a', function(e){
				e.preventDefault();
			} );
			...
			if ( 'help_box' == app.preselectZone && app.iframe.find('#eckb-help-box').css( 'display' ) == 'none' ) {
				app.iframe.find('.eckb-help-box-toggle').trigger('click');
			}
