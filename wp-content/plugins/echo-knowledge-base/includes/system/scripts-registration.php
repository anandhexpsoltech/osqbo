...
function epkb_register_public_resources() {
	...
	wp_register_style( 'epkb-help-box-styles', Echo_Knowledge_Base::$plugin_url . 'css/helpbox' . $suffix . '.css', array(), Echo_Knowledge_Base::$version );
	...
	wp_register_script( 'epkb-help-box-scripts', Echo_Knowledge_Base::$plugin_url . 'js/helpbox' . $suffix . '.js', array('jquery'), Echo_Knowledge_Base::$version );
...
function epkb_enqueue_help_box() {
	wp_enqueue_style( 'epkb-help-box-styles' );
	wp_enqueue_script( 'epkb-help-box-scripts' );
}
add_action( 'epkb_enqueue_help_box_scripts', 'epkb_enqueue_help_box' ); // use this action in any place to add scripts $kb_id as a parameter
...
function epkb_load_editor_styles() { 
	...
	<link rel="stylesheet" href="<?php echo Echo_Knowledge_Base::$plugin_url; ?>css/public-styles<?php echo $suffix; ?>.css" media="all" />
	<link rel="stylesheet" href="<?php echo Echo_Knowledge_Base::$plugin_url; ?>css/editor<?php echo $suffix; ?>.css" media="all" />
