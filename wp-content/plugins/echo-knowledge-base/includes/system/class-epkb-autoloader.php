	...
	public static function autoload( $class ) {
		...
		if ( $classes === null ) {
			$classes = array(
				...
				// HELP BOX
				'epkb_help_box_ctrl'                =>  'includes/features/help-box/class-epkb-help-box-ctrl.php',
				'epkb_help_box_search'              =>  'includes/features/help-box/class-epkb-help-box-search.php',
				'epkb_help_box_view'                =>  'includes/features/help-box/class-epkb-help-box-view.php',
			);
		}
