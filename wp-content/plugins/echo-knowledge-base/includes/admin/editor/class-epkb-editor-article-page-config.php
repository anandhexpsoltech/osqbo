...
class EPKB_Editor_Article_Page_Config extends EPKB_Editor_Base_Config {
	...
	private static function toc_zone() {
		...
		$settings = [
			...
			'toc_left' => [
				'editor_tab' => self::EDITOR_TAB_FEATURES,
				'label'            => __( 'Display on the Left', 'echo-knowledge-base' ),
				'type'        => EPKB_Input_Filter::SELECTION,
				'style'       => 'small',
				'description' => 'Number 1 places the element at the top, 2 below it, and so on.',
				'options'    => array(
					'0' => __( 'Not displayed', 'echo-knowledge-base' ),
					'1' => '1',
					'2' => '2',
			...
			'toc_right' => [
				'editor_tab' => self::EDITOR_TAB_FEATURES,
				'label'            => __( 'Display on the Right', 'echo-knowledge-base' ),
				'type'        => EPKB_Input_Filter::SELECTION,
				'style'       => 'small',
	...
	public function get_config( $kb_config ) {
		...
		// add values to kb_config for help box 
		$kb_config += epkb_get_instance()->settings_obj->get_settings_or_default();
	// TODO	$editor_config += EPKB_Editor_Common_Config::help_box_zone();
