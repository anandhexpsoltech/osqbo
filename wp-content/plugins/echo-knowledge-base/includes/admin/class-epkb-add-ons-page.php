...
class EPKB_Add_Ons_Page {
	...
	private static function display_add_ons_details() {
		...
		$license_content = '<h3>' . sprintf( __( 'You can access your license account %s here%s' , 'echo-knowledge-base' ), '<a href="https://www.echoknowledgebase.com/account-dashboard/" target="_blank" rel="noopener">', '</a>' ) . '</h3>' .
