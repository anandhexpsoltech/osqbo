...
class EPKB_Settings_Specs {
	...
	public static function get_fields_specification() {
		...
		$plugin_settings = array(
			...
			// Setup
			'help_box_enable'                              => array(
				'label'       => __( 'Help Box', 'echo-knowledge-base' ),
				'name'        => 'help_box_enable',
				'type'        => EPKB_Input_Filter::CHECKBOX,
				'default'     => 'off'
			),
			'help_box_display_mode'                              => array(
				'label'       => __( 'Display Mode', 'echo-knowledge-base' ),
				'name'        => 'help_box_display_mode',
			...
			'help_box_logo_image_url'                           => array(
				'label'       => __( 'Logo Image URL', 'echo-advanced-search' ),
				'name'        => 'help_box_logo_image_url',
				'size'        => '60',
				'max'         => '300',
				'min'         => '0',
				'mandatory'    => false,
			...
			'help_box_page_ids'                                 => array(
				'label'       => __( 'Page ids to Display on', 'echo-knowledge-base' ),
				'name'        => 'help_box_page_ids',
				'mandatory'   => false,
				'min'         => '1',
				'type'        => EPKB_Input_Filter::TEXT,
				'default'     => ''
			...
			// Launcher
			'help_box_launcher_when_to_display'                 => array(
				'label'       => __( 'When to display Help Box?', 'echo-knowledge-base' ),
				'name'        => 'help_box_launcher_when_to_display',
				'type'        => EPKB_Input_Filter::SELECTION,
				'options'     => array(
			...
			'help_box_launcher_background_color'                => array(
				'label'       => __( 'Background', 'echo-knowledge-base' ),
				'name'        => 'help_box_launcher_background_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
			...
			'help_box_launcher_background_hover_color'          => array(
				'label'       => __( 'Background Hover', 'echo-knowledge-base' ),
				'name'        => 'help_box_launcher_background_hover_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_launcher_icon_color'                      => array(
				'label'       => __( 'Icon', 'echo-knowledge-base' ),
				'name'        => 'help_box_launcher_icon_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_launcher_icon_hover_color'                => array(
				'label'       => __( 'Icon Hover', 'echo-knowledge-base' ),
				'name'        => 'help_box_launcher_icon_hover_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			// Help Box
			'help_box_background_color'                         => array(
				'label'       => __( 'Background', 'echo-knowledge-base' ),
				'name'        => 'help_box_background_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_text_color'                               => array(
				'label'       => __( 'Text Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_text_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_text_hover_color'                         => array(
				'label'       => __( 'Text Hover Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_text_hover_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_back_icon_color'                          => array(
				'label'       => __( 'Icon Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_back_icon_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_back_icon_color_hover_color'              => array(
				'label'       => __( 'Icon Hover Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_back_icon_color_hover_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_back_icon_bg_color'                       => array(
				'label'       => __( 'Background Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_back_icon_bg_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_back_icon_bg_color_hover_color'           => array(
				'label'       => __( 'Background Color Hover Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_text_hover_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_faqs_top_button_title'                    => array(
				'label'       => __( 'Top Button Title', 'echo-knowledge-base' ),
				'name'        => 'help_box_faqs_top_button_title',
				'size'        => '30',
				'max'         => '50',
				'min'         => '1',
				'type'        => EPKB_Input_Filter::TEXT,
			...
			'help_box_faqs_search_placeholder'                  => array(
				'label'       => __( 'Search Placeholder', 'echo-knowledge-base' ),
				'name'        => 'help_box_faqs_search_placeholder',
				'size'        => '30',
				'max'         => '50',
				'min'         => '1',
				'type'        => EPKB_Input_Filter::TEXT,
			...
			'help_box_faqs_category_ids'                        => array(
				'label'       => __( 'List of Category IDs', 'echo-knowledge-base' ),
				'name'        => 'help_box_faqs_category_ids',
				'mandatory'   => false,
				'type'        => EPKB_Input_Filter::TEXT,
				'default'     => ''
			),
			'help_box_faqs_read_more_text'                      => array(
				'label'       => __( 'Read More Text', 'echo-knowledge-base' ),
				'name'        => 'help_box_faqs_read_more_text',
				'size'        => '30',
				'max'         => '100',
				'min'         => '0',
				'mandatory'   => false,
			...
			'help_box_faqs_read_more_text_color'                => array(
				'label'       => __( 'Read More Text Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_faqs_read_more_text_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_faqs_read_more_text_hover_color'          => array(
				'label'       => __( 'Read More Text Hover Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_faqs_read_more_text_hover_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_top_button_color'                        => array(
				'label'       => __( 'Button Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_top_button_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_top_button_hover_color'                  => array(
				'label'       => __( 'Button Hover Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_top_button_hover_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_top_button_text_color'                   => array(
				'label'       => __( 'Button Text Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_top_button_text_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_top_button_text_hover_color'             => array(
				'label'       => __( 'Button Text Hover Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_top_button_text_hover_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			// Contact Us
			'help_box_contact_title'                            => array(
				'label'       => __( 'Title', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_title',
				'size'        => '30',
				'max'         => '50',
				'min'         => '1',
				'type'        => EPKB_Input_Filter::TEXT,
			...
			'help_box_contact_top_button_title'                 => array(
				'label'       => __( 'Top Button Title', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_top_button_title',
				'size'        => '30',
				'max'         => '50',
				'min'         => '1',
				'type'        => EPKB_Input_Filter::TEXT,
			...
			'help_box_contact_submission_email'                 => array(
				'label'       => __( 'Email To Receive Contact Form Submissions', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_submission_email',
				'size'        => '30',
				'max'         => '50',
				'min'         => '0',
				'mandatory'   => false,
			...
			'help_box_contact_success_message'                  => array(
				'label'       => __( 'Email Sent Success Message', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_success_message',
				'size'        => '30',
				'max'         => '100',
				'min'         => '0',
				'mandatory'   => false,
			...
			'help_box_contact_name_placeholder'                 => array(
				'label'       => __( 'Name Placeholder', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_name_placeholder',
				'size'        => '30',
				'max'         => '50',
				'min'         => '1',
				'type'        => EPKB_Input_Filter::TEXT,
			...
			'help_box_contact_user_email_placeholder'           => array(
				'label'       => __( 'Email Placeholder', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_user_email_placeholder',
				'size'        => '30',
				'max'         => '50',
				'min'         => '1',
				'type'        => EPKB_Input_Filter::TEXT,
			...
			'help_box_contact_subject_placeholder'              => array(
				'label'       => __( 'Subject Placeholder', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_subject_placeholder',
				'size'        => '30',
				'max'         => '50',
				'min'         => '1',
				'type'        => EPKB_Input_Filter::TEXT,
			...
			'help_box_contact_comment_placeholder'              => array(
				'label'       => __( 'Comment Placeholder', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_comment_placeholder',
				'size'        => '30',
				'max'         => '50',
				'min'         => '1',
				'type'        => EPKB_Input_Filter::TEXT,
			...
			'help_box_contact_button_title'                     => array(
				'label'       => __( 'Submit Button Text', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_button_title',
				'size'        => '30',
				'max'         => '50',
				'min'         => '1',
				'type'        => EPKB_Input_Filter::TEXT,
			...
			'help_box_contact_button_color'                     => array(
				'label'       => __( 'Button Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_button_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_contact_button_hover_color'               => array(
				'label'       => __( 'Button Hover Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_button_hover_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_contact_button_text_color'                => array(
				'label'       => __( 'Button Text Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_text_color',
				'size'        => '10',
				'max'         => '7',
				'min'         => '7',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
			...
			'help_box_contact_button_text_hover_color'          => array(
				'label'       => __( 'Button Text Hover Color', 'echo-knowledge-base' ),
				'name'        => 'help_box_contact_text_hover_color',
				'size'        => '10',
				'max'         => '7',
