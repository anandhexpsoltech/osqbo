...
class EPKB_New_Features_Page {
	...
	private static function features_list( $features=array() ) {
		...
		/* $features['2021.03.01'] = array(
			...
			'description'       => '<p>' . __( 'Provide a Help Box on any page of your website. Users can easily search your Knowledge Base or Contact you without leaving the page. Finding answers specific to the page.', 'echo-knowledge-base') . '</p>',
			'image'             => 'https://www.echoknowledgebase.com/wp-content/uploads/2021/01/featured-screenshots-print-button.jpg',
			'learn_more_url'    => ( epkb_get_instance()->kb_config_obj->get_value( 'print_button_enable', 1, null ) == 'on' ) ? EPKB_Utilities::get_one_editor_url( 'article_page', 'print_button' ) : 'https://www.echoknowledgebase.com/documentation/article-header-section-title-author-breadcrumbs/',
		...
		$features['2021.02.01'] = array(
			...
			'image'             => 'https://www.echoknowledgebase.com/wp-content/uploads/2021/01/featured-screenshots-print-button.jpg',
			'learn_more_url'    => ( epkb_get_instance()->kb_config_obj->get_value( 'print_button_enable', 1, null ) == 'on' ) ? EPKB_Utilities::get_one_editor_url( 'article_page', 'print_button' ) : 'https://www.echoknowledgebase.com/documentation/print-button/',
		   'button_name'       => __( 'Try Now!', 'echo-knowledge-base'),
		   'plugin-type'       => 'core',
			'type'              => 'new-feature'
		);
	   ...
	   $features['2021.01.02'] = array(
		...
		$features['2020.12.23'] = array(
			...
			'learn_more_url'    => EPKB_Utilities::is_advanced_search_enabled() ? EPKB_Utilities::get_one_editor_url( 'article_page', 'search_box_zone' ) : '',
		    'button_name'       => __( 'Try Now!', 'echo-knowledge-base'),
			'plugin-type'       => 'add-on',
			'type'              => 'new-feature'
		);
